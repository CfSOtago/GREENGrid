...
The following table provides more detail to aid error checking. If the above plot and this table flag a lot of errors then some re-naming of the circuit labels (column names) may be necessary. 
