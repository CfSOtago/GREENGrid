...
# Packages needed in thie .Rmd file ----
...
```{r reportStatus, echo = FALSE}
if(baTest){
  print(paste0("Test data run using data from ", fpath))
} else {
  print(paste0("Full data run using data from ", fpath))
}
```
...
```{r initialDateFormatTable, echo=FALSE}
