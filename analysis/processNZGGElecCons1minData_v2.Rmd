...
> NB: This table is only legible in the html version of this report. A version is saved in `r paste0(outPath, "circuitLabelCheck.csv")` for viewing in e.g. xl.
...
> NB: As before, the table is only legible in the html version of this report. A version is saved in `r paste0(outPath, "circuitLabelMetaDataCheckTable.csv")` for viewing in e.g. xl.
