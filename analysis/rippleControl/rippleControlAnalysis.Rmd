...
Variables available under load control:
...
NA and Inf errors indicate records where we can't match the ICP counts from the perfomrance data to the specfic EDB in the load control data.
