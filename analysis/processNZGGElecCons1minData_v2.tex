...
\texttt{@dataknut})}
  ...
  \postdate{\par}
  \date{Last run at: 2018-05-15 17:41:43}
...
\NormalTok{knitr}\OperatorTok{::}\KeywordTok{kable}\NormalTok{(}\DataTypeTok{caption =} \StringTok{"Number of files & min/max date (as char) with given date column names by inferred date format"}\NormalTok{, t)}
\end{Highlighting}
\end{Shaded}

\begin{longtable}[]{@{}llrll@{}}
\caption{Number of files \& min/max date (as char) with given date
...
Analysis completed in 280.204 seconds ( 4.67 minutes) using
...
## [4] lubridate_1.7.4     data.table_1.10.4-3 knitr_1.20         
## [7] ggplot2_2.2.1.9000  nzGREENGrid_0.1.0  
## 
## loaded via a namespace (and not attached):
##  [1] Rcpp_0.12.16      pillar_1.2.2      compiler_3.4.4   
##  [4] plyr_1.8.4        highr_0.6         bindr_0.1.1      
