...
date: 'Last run at: 2018-10-17 17:23:51'
output:
...
##    46741        0        2 
##                                            
## Value      44e70b238906b67964c088be78366d2c
## Frequency                             34254
## Proportion                            0.733
##                                            
## Value      b4ed70fa9b8d2419411908df6d78ee2a
## Frequency                             12487
## Proportion                            0.267
## ---------------------------------------------------------------------------
```
...
Gzipped the file to reduce it from 40.02 MB to 4.68 MB.
...
Analysis completed in 21.93 seconds ( 0.37 minutes) using [knitr](https://cran.r-project.org/package=knitr) in [RStudio](http://www.rstudio.com) with R version 3.5.1 (2018-07-02) running on x86_64-apple-darwin15.6.0.
