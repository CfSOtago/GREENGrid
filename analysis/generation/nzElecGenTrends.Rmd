...
ggplot(plotDT, aes(x = month, y = sumkWh/1000000, fill = Fuel_Code)) +
  geom_col() +
  facet_grid(. ~ year) +
  labs(caption = ggParams$figCaption, y = "Total GWh", x = "Half hour") +
...
ggplot(plotDT, aes(x = month, y = meankWh/1000000, fill = Fuel_Code)) +
  geom_col() +
  facet_grid(. ~ year) +
  labs(caption = ggParams$figCaption, y = "Mean GWh", x = "Half hour") +
  theme(legend.title=element_blank())
```
...
ggplot(plotDT, aes(x = month, y = sdkWh/1000000, fill = Fuel_Code)) +
  ...
  facet_grid(year ~ .) +
  labs(caption = ggParams$figCaption, y = "SD GWh", x = "Half hour") +
  theme(legend.title=element_blank())
```
...
ggplot(plotDT, aes(x = month, y = cov, fill = Fuel_Code)) +
  geom_col(position = "dodge") +
  facet_grid(year ~ .) +
  labs(caption = ggParams$figCaption, y = "CoV GWh", x = "Half hour") +
  theme(legend.title=element_blank())
```
