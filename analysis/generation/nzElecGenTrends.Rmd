...
Figures \@ref(fig:dailyTotalPlotPoint) and \@ref(fig:dailyTotalPlotCol) show the same trends but using daily data to highlight seasonal patterns over time. Annotations use information from:
