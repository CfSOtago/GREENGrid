...
Then list the columns/variables.

```{r loadData}

dt <- data.table::fread(path.expand("/Volumes/hum-csafe/Research Projects/GREEN Grid/externalData/OtagoUni/MedicalSchoolBuildingsOtago.csv"), 
                  )
