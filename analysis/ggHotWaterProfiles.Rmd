...
ggplot2::ggsave(paste0(projLoc, "/data/", circuitPattern, "_", dateFrom, "_", dateTo, "_profilePlot.png"),
...
Note that the code saves a high definition version of the chart and the average profiles out to the repo (in `r ofile`) for future re-use.
