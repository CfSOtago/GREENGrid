 ...
 * the empirical cumulative distribution function ([ECDF](http://ggplot2.tidyverse.org/reference/stat_ecdf.html)) to understand the shape.
...
t <- summary(testDT)
kable(caption = paste0("Summary of ", circuitPattern, " circuits (10% sample)"), t)
