...
myPlot <- ggplot2::ggplot(subset(LoadDistMPDT, Period %in% c("Morning Peak")), aes(x=powerW)) +
  geom_density() +
  theme(text = element_text(family = "Cambria")) +
  ggtitle("Hot water winter morning peak density") 
 # facet_grid(DOW ~ .) +
myPlot



myPlot <- ggplot2::ggplot(subset(LoadDistMPDT, Period %in% c("Evening Peak")), aes(x=powerW)) +
  geom_density() +
  theme(text = element_text(family = "Cambria")) +
  ggtitle("Hot water winter evening peak density") 
 # facet_grid(DOW ~ .) +
myPlot
