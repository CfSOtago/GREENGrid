...
TestDT <- TestDT[, power1 := NA]
TestDT <- TestDT[, power1 := ifelse(obsHourMin >=hms::as.hms("03:45:00") & obsHourMin <= hms::as.hms("05:59:00"), powerW, power1)]
Test2DT <- TestDT
Test2DT <- Test2DT[, .(ifelse(obsHourMin >= hms::as.hms("00:00:00")& obsHourMin<=hms::as.hms("03:45:00"), NULL, obsHourMin))]
