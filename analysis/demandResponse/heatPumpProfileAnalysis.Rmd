...
LightPriceCalcDT <- LightPriceCalcDT[, WP2015 := 
                                       LightpriceDT$meanprice *  LightHHTotDT$`ConsumptionTot2015`] #Calculating spot market orices for an average day in each season in NZD. To calculate yearly charge sum(LightPriceCalcDT$WP2015*90)/1000000 in MIO NZD
...
LightHHCPDDT <- LightHHCPDDT[, kWperHh2015 := (ConsumptionHH2015 *
                                                2)/90/1000]#kW per household and half hour for one day
LightHHCPDDT <- LightHHCPDDT[, kWperHh2017 := (ConsumptionHH2017 *
                                                2)/90]#kW per household and half hour for one day
