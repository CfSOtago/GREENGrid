...
#EcoVaSumSC0DT <- EcoVaSumSC0DT[, UNI := ifelse(Region== "Upper North Island", cop(""), NA)]
...
myPlot <- ggplot2::ggplot(EcoVaSumSC0DT, aes(x = Period, fill = Region)) +
  ...
  theme(text = element_text(family = "Cambria")) +
  facet_grid(season ~ .) +
  ggtitle("Baseline cost scenario for heat pump") +
...
myPlot <- ggplot2::ggplot(EcoVaSumSC0DT[season = "Winter"], aes(x = Period, fill = Region)) +
  geom_bar(aes(y= V1), stat = "identity", position = "dodge") +
  #geom_line(aes(y= V1)) +
  theme(text = element_text(family = "Cambria")) +
  facet_grid(season ~ .) +
