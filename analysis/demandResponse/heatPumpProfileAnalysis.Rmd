...
#Input variables
NZhouseholds <- 1796331.30947204 #RBS assumption for 2015 households
EecaLight <- (1577 * 1000 * 1000) / (NZhouseholds) #Yearly kWh per household for lighting based on EECA GWh and RBS number of households
...
myPlot <- ggplot2::ggplot(LightHHDT, aes(x = obsHalfHour)) +
  ...
  scale_color_manual(legend_title, labels = c("2015",
                                              ...
                                              "2029"), values = c("#332288",
                                                                  ...
                                                                  "#882255")) +
  facet_grid(season ~ .) +
  labs(x='Time of Day', y='Energy (Wh)') +
