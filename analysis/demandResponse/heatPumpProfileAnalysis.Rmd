...
MiSimWinterHWDT <- copy(MicroSimShifDT)
#______________________________________________________________
...
#Visualisation
#MiSimWinterHWDT is generated just before the variance analysis and half hour average
#Changes the order in facet_grid
MiSimWinterHWDT$DOW <- factor(MicroSimShifDT$DOW, levels = c("Mon",
                                                            "Tue",
                                                            "Wed",
                                                            "Thu",
                                                            "Fri",
...
legend_title <- "Period"
myPlot <- ggplot2::ggplot(subset(MiSimWinterHWDT, hhID %in% c("rf_21"))
                          , aes(x = obsHourMin, colour=LsPeriod)) +
