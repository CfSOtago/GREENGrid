...
MiSimWinterHWDT$DOW <- factor(MicroSimShifDT$DOW, levels = c("Mon",
                                                            ...
                                                            "Sun"))
legend_title <- "Period"
myPlot <- ggplot2::ggplot(subset(MicroSimShifDT, hhID %in% c("rf_21"))
                          , aes(x = obsHourMin, colour=LsPeriod)) +
  geom_line(aes(y=powerW), size=0.6) +
  theme(text = element_text(family = "Cambria")) +
  scale_color_discrete(breaks=c("Off Peak 1 (Morning)",
                                ...
                                "Off Peak 1 (EP2 shifted)",
                                "Off Peak 1 (Evening)"))+
  ggtitle("Heat pump power in winter for rf_21") +
  facet_grid(DOW ~ .) +
  labs(x='Time of Day', y="Power in W") +
  scale_x_time(breaks = c(hms::as.hms("00:00:00"), 
                          hms::as.hms("04:00:00"), 
...
ggsave("Heat pump power in winter for rf_21.jpeg", dpi=600)
