...
myPlot <- ggplot2::ggplot(sc3data, aes(x = obsHalfHour)) +
  geom_line(aes(y=PumpandWater, colour = "PumpandWater"), size=0.5) +
  geom_line(aes(y=GWhREF, colour = "GWhREF"), size=0.5) +
  geom_line(aes(y=GWhLight, colour = "GWhLight"), size=0.5) +
  geom_line(aes(y=GWhHW, colour = "GWhHW"), size=0.5) +
  geom_line(aes(y=GWhHP, colour = "GWhHP"), size=0.5) +

  theme(text = element_text(family = "Cambria")) +
  ggtitle("Lighting energy consumption profile for an average day per season") +
  scale_color_manual(legend_title, labels = c("HP|REF|LIGHT|HW",
                                              "Hot Water Heaters (HW)",
                                              "Lighting (LIGHT)",
                                              "Refrigerators (REF)",
                                              "Heat Pumps (HP)"
                                              ), values = c("blue",
...
#ggsave("Lighting energy for an average day per seasonand household forecast.jpg", dpi=600)
...
sc3data <- EnergyOutput2[, .(EnergyOut = sum(ConsumptionTot2029)/1000),
                   keyby = .(season, Period)]
sc3data
