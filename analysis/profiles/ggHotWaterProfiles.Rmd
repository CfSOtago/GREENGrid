---
title: 'GREEN Grid Hot Water Profiles'
...
baTest <- 0 # test on local data source (1) or full HPS (0) data?
 ...
 * Anderson, B. (`r 1900 + as.POSIXlt(Sys.Date())$year`) GREEN Grid Hot Water Profiles, University of Otago: Dunedin, NZ.
...
kable(caption = paste0("Counts of ", circuitPattern, " observations by label and household"), t)
```
...
ofile <- paste0(outPath, "profiles/", circuitPattern, "_", dateFrom, "_", dateTo, "_meanW_hhID_profiles_by_season.csv")
...
Note that the code saves a high definition version of the chart and the average profiles out to the repo (in `r ofile`.gz) for future re-use.
