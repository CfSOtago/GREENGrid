...
plotFile <- paste0(circuitPattern, "_", dateFrom, "_", dateTo, "_byHouseholdSeasonalProfilePlot.png")
...
# save the plot at high def
plotFile <- paste0(circuitPattern, "_", dateFrom, "_", dateTo, "_overallMeanSeasonalProfilePlot.png")
ggplot2::ggsave(plotFile,
                height = 10, width = 8, dpi = 400)
print(paste0("Saving plot to ", plotFile))
...
# save the plot at high def
plotFile <- paste0(circuitPattern, "_", dateFrom, "_", dateTo, "_overallMedianSeasonalProfilePlot.png")
ggplot2::ggsave(plotFile,
                height = 10, width = 8, dpi = 400)
print(paste0("Saving plot to ", plotFile))
